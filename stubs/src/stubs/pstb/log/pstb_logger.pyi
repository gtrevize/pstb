...
class DatabaseHandler(logging.Handler):
    def __init__(self, db_filename: Incomplete | None = ..., log_name: Incomplete | None = ..., formatter: Incomplete | None = ...) -> None: ...
    conn: Incomplete
    cursor: Incomplete
...
def add_output_to_database(db_filename, log_name: Incomplete | None = ..., formatter: Incomplete | None = ...) -> None: ...
